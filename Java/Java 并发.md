...
### 2.5 当线程进入 synchronized 方法 A 后，能否进入同一个对象的 synchronized 方法 B？
...
shutDownNow() 是强制性关闭，通过Interrupt() 机制立刻停止所有正在执行的任务，清空队列并返回未执行的任务列表

<img src=".\images\image-20260311210249771.png" alt="image-20260311210249771" style="zoom:80%;" />
...
1. **程序启动初始化(等待其他加载完成，主线程再去执行)**
2. **多任务并行汇总（主任务切片为多个子任务，最后汇总）**
